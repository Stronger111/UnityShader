...
namespace UnityEngine.Rendering.Universal
{
    ...
    public class UniversalRenderPipelineAsset : RenderPipelineAsset, ISerializationCallbackReceiver
    {
        ...
        [SerializeField] public ScriptableRendererData m_RendererData = null;

        // Renderer settings
        [SerializeField] public ScriptableRendererData[] m_RendererDataList = new ScriptableRendererData[1];
        [SerializeField] public int m_DefaultRendererIndex = 0;
...
#pragma warning restore 414
        ...
        public static readonly string packagePath = "Assets/Scripts/Render/URP";
